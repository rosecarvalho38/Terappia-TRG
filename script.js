// static/js/script.js (VERSÃO DEFINITIVA E FUNCIONAL - JORNADA DE RESGATE)

document.addEventListener('DOMContentLoaded', () => {

    // Objeto central que guarda o estado dos planos e vagas.
    // É declarado no topo para ser acessível por múltiplas funções.
    const planosInfo = {
    ...
    /**
     * Função reutilizável para atualizar a caixa de oferta na tela com os dados mais recentes.
     */
    ...
    /**
     * Função para inicializar as vagas com valores aleatórios no carregamento da página.
     */
    ...
    /**
     * Função do Checklist de Sintomas que revela o resto da página.
     */
  ...
  { name: 'Lourdes Pereira' }, { name: 'Marta Almeida' }, { name: 'Nair Alves' }
        ...
        function scheduleNextEvent() {
            ...
            setTimeout(() => {
                if (Math.random() > 0.7 && shuffledCommentIndex < remainingComments.length) {
