document.addEventListener('DOMContentLoaded', () => {
    ...
    function initHeadlineAnimation() {
        ...
        if (headline) {
            // A classe 'is-visible' é adicionada ao H1, e o CSS cuida da animação dos spans filhos.
            setTimeout(() => {
     ...
     * Ativa o botão de solução e revela o conteúdo principal.
     */
     ...
     * Carrega comentários e adiciona novos em tempo real (simulado).
     */
